...
st.set_page_config(page_title="FacturasAI BETA 3", page_icon="🧾", layout="wide")
...
EXPENSE_OPTIONS = [
    ...
    "Gestoria / Asesoria", "Arrendamiento", "Equipos / Hardware", "Otros gastos",
]
DOC_OPTIONS = ["Factura", "Factura simplificada", "Ticket", "Recibo", "Nota de cargo", "Otro"]
...
with st.sidebar:
    st.title("🧾 FacturasAI")
    st.caption("BETA 3 · Facturación española")
    st.divider()
...
st.markdown(
    """
<div class="hero"><h1>Gestor de facturas · BETA 3</h1>
...
if "invoice_df" in st.session_state:
    ...
    editor_columns = {
        ...
        "modelo_303": st.column_config.SelectboxColumn("Modelo 303", options=["", "Sí", "No"], width="small"),
